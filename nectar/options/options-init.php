        ...
        'fields' => array(
           ...
           array(
			...
			array(
                ...
                'sub_desc' => __('Please enter in your google analytics tracking code here.', NECTAR_THEME_NAME),
	...
	$sections[] = array(
        ...
        'fields' => array( 
			...
			array(
                ...
                'type' => 'select', 
                'title' => __('Home Slider Caption', NECTAR_THEME_NAME),
                'desc' => '',
                'options' => $typography_mixed_fonts
			),
	...
	$sections[] = array(
        ...
        'fields' => array( 
			array(
			 ...
			 array(
                'id' => 'author_gravatar_size', 
                'type' => 'text', 
                'title' => __('Author\'s Gravatar Size', NECTAR_THEME_NAME),
                'sub_desc' => __('Don\'t include "px" in the string. e.g. 80', NECTAR_THEME_NAME),
                'desc' => '',
                'validate' => 'numeric'
			),    
